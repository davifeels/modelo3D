const STRINGS = {
  ...
  plans_hero_badge:  { pt: 'Acesso liberado na hora após a compra', en: 'Access unlocked right after purchase' },
  ...
  // ── Login (SEM registro: acesso só via compra) ────────────────────────────
  ...
  login_forgot:      { pt: 'Esqueci minha senha', en: 'Forgot my password' },
  login_forgot_hint: { pt: 'Digite seu e-mail acima e clique de novo em "Esqueci minha senha".', en: 'Type your e-mail above and click "Forgot my password" again.' },
  login_forgot_sent: { pt: 'Se o e-mail estiver cadastrado, enviamos um link para redefinir a senha.', en: 'If the e-mail is registered, we sent a link to reset your password.' },

  // ── Redefinição de senha (/reset-password) ────────────────────────────────
  reset_title:       { pt: 'Redefinir senha', en: 'Reset password' },
  reset_subtitle:    { pt: 'Escolha uma nova senha para a sua conta. O link é válido por 1 hora.', en: 'Choose a new password for your account. The link is valid for 1 hour.' },
  reset_new:         { pt: 'Nova senha', en: 'New password' },
  reset_confirm:     { pt: 'Confirmar nova senha', en: 'Confirm new password' },
  reset_btn:         { pt: 'Redefinir senha', en: 'Reset password' },
  reset_done:        { pt: 'Senha redefinida com sucesso! Entre com a nova senha.', en: 'Password reset! Sign in with your new password.' },
  reset_go_login:    { pt: 'Ir para o login', en: 'Go to sign in' },
  reset_err_short:   { pt: 'A senha precisa de pelo menos 8 caracteres.', en: 'Password must be at least 8 characters.' },
  reset_err_match:   { pt: 'As senhas não coincidem.', en: 'Passwords do not match.' },
  reset_err_token:   { pt: 'Link inválido ou expirado. Peça um novo em "Esqueci minha senha".', en: 'Invalid or expired link. Request a new one from "Forgot my password".' },
  login_no_account:  { pt: 'Ainda não tem acesso?', en: "Don't have access yet?" },
  login_buy_link:    { pt: 'Comprar acesso', en: 'Buy access' },
  err_login:         { pt: 'E-mail ou senha incorretos.', en: 'Wrong e-mail or password.' },
  err_blocked:       { pt: 'Conta bloqueada. Fale com o suporte.', en: 'Account blocked. Contact support.' },
  ...
  // ── Landing page ──────────────────────────────────────────────────────────
  ld_nav_features:   { pt: 'Funcionalidades', en: 'Features' },
  ld_nav_plans:      { pt: 'Planos', en: 'Plans' },
  ld_nav_faq:        { pt: 'FAQ', en: 'FAQ' },
  ld_nav_login:      { pt: 'Entrar', en: 'Sign in' },
  ld_hero_title:     { pt: 'Fatie modelos 3D grandes em peças que cabem na sua impressora', en: 'Slice big 3D models into parts that fit your printer' },
  ld_hero_sub:       { pt: 'O ZefiroSplit divide malhas 3D em partes encaixáveis com pinos e cavidades gerados automaticamente — pinte onde cortar, visualize o encaixe e exporte STL, OBJ ou 3MF prontos para imprimir.', en: 'ZefiroSplit splits 3D meshes into interlocking parts with automatically generated pins and cavities — paint where to cut, preview the fit and export print-ready STL, OBJ or 3MF.' },
  ld_cta_buy:        { pt: 'Comprar Acesso', en: 'Buy Access' },
  ld_cta_sub:        { pt: 'Acesso imediato após a confirmação da compra', en: 'Instant access after purchase confirmation' },
  ld_benefits_title: { pt: 'Por que o ZefiroSplit?', en: 'Why ZefiroSplit?' },
  ld_b1_t:           { pt: 'Imprima além do volume da impressora', en: 'Print beyond your printer volume' },
  ld_b1_d:           { pt: 'Divida modelos gigantes em peças que cabem na mesa — sem perder detalhes.', en: 'Split huge models into bed-sized parts — without losing detail.' },
  ld_b2_t:           { pt: 'Encaixes gerados automaticamente', en: 'Auto-generated joints' },
  ld_b2_d:           { pt: 'Pinos e cavidades com folga calibrada para FDM: as peças se encaixam de primeira.', en: 'Pins and cavities with FDM-calibrated clearance: parts fit on the first try.' },
  ld_b3_t:           { pt: 'Controle total do corte', en: 'Full cut control' },
  ld_b3_d:           { pt: 'Pinte a região do corte com o pincel ou aceite as sugestões automáticas.', en: 'Paint the cut region with the brush or accept automatic suggestions.' },
  ld_b4_t:           { pt: 'Direto no navegador', en: 'Right in the browser' },
  ld_b4_d:           { pt: 'Sem instalar nada: arraste o arquivo, corte e exporte.', en: 'Nothing to install: drag the file, cut and export.' },
  ld_feat_title:     { pt: 'Funcionalidades principais', en: 'Main features' },
  ld_f1:             { pt: 'Corte por pintura livre (pincel 3D)', en: 'Free-paint cutting (3D brush)' },
  ld_f2:             { pt: 'Máscara multi-peça para dividir em N partes', en: 'Multi-part mask to split into N parts' },
  ld_f3:             { pt: 'Sugestões automáticas de corte', en: 'Automatic cut suggestions' },
  ld_f4:             { pt: 'Pinos e cavidades com folga configurável', en: 'Pins and cavities with configurable clearance' },
  ld_f5:             { pt: 'Exportação STL, OBJ e 3MF (peça a peça ou ZIP)', en: 'STL, OBJ and 3MF export (per part or ZIP)' },
  ld_f6:             { pt: 'Visualização 3D com encaixe explodido', en: '3D preview with exploded fit' },
  ld_plans_title:    { pt: 'Acesso por assinatura', en: 'Subscription access' },
  ld_plans_sub:      { pt: 'Essencial para quem fatia de vez em quando, Pro ilimitado para produção. A compra libera seu acesso na hora.', en: 'Essential for occasional slicing, unlimited Pro for production. Purchase unlocks your access instantly.' },
  ld_testi_title:    { pt: 'Quem usa, recomenda', en: 'Users recommend it' },
  ld_t1_n:           { pt: 'Marcos A. — maker', en: 'Marcos A. — maker' },
  ld_t1_d:           { pt: '"Imprimi um capacete inteiro em uma Ender 3. Os encaixes fecharam perfeitos de primeira."', en: '"Printed a full helmet on an Ender 3. The joints fit perfectly on the first try."' },
  ld_t2_n:           { pt: 'Carla S. — estúdio de props', en: 'Carla S. — prop studio' },
  ld_t2_d:           { pt: '"O modo multi-peça economiza horas: divido esculturas em 8 partes com conectores prontos."', en: '"Multi-part mode saves hours: I split sculptures into 8 parts with ready connectors."' },
  ld_t3_n:           { pt: 'Rafael M. — engenharia', en: 'Rafael M. — engineering' },
  ld_t3_d:           { pt: '"Melhor custo-benefício que qualquer plugin de CAD que testamos para seccionar protótipos."', en: '"Better value than any CAD plugin we tried for sectioning prototypes."' },
  ld_footer_product: { pt: 'Produto', en: 'Product' },
  ld_footer_support: { pt: 'Suporte', en: 'Support' },
  ld_footer_legal:   { pt: 'Legal', en: 'Legal' },
  ld_footer_terms:   { pt: 'Termos de uso', en: 'Terms of service' },
  ld_footer_privacy: { pt: 'Privacidade', en: 'Privacy' },
  ld_footer_contact: { pt: 'Contato', en: 'Contact' },
  ld_footer_note:    { pt: 'ZefiroSplit — fatiamento inteligente de malhas 3D.', en: 'ZefiroSplit — smart 3D mesh splitting.' },
  ld_shot_caption:   { pt: 'Interface real do ZefiroSplit — modelo de 499.914 faces carregado, pintado e pronto para o corte', en: 'The real ZefiroSplit interface — a 499,914-face model loaded, painted and ready to split' },
  ld_stat1_v:        { pt: 'STL · OBJ · 3MF', en: 'STL · OBJ · 3MF' },
  ld_stat1_l:        { pt: 'importa e exporta os formatos padrão da impressão 3D', en: 'imports and exports the standard 3D-printing formats' },
  ld_stat2_v:        { pt: '500 mil+', en: '500k+' },
  ld_stat2_l:        { pt: 'faces processadas direto no navegador, sem instalar nada', en: 'faces processed right in the browser, nothing to install' },
  ld_stat3_v:        { pt: '1 clique', en: '1 click' },
  ld_stat3_l:        { pt: 'conta-gotas seleciona a região conectada inteira', en: 'eyedropper selects the whole connected region' },
  ld_stat4_v:        { pt: '1 mm', en: '1 mm' },
  ld_stat4_l:        { pt: 'folga de encaixe calibrada para FDM, ajustável por lado', en: 'FDM-calibrated fit clearance, adjustable per side' },
  ld_inside_title:   { pt: 'Por dentro da ferramenta', en: 'Inside the tool' },
  ld_in1_t:          { pt: 'Pinte exatamente onde a peça deve dividir', en: 'Paint exactly where the part should split' },
  ld_in1_d:          { pt: 'Três modos de seleção trabalham juntos: pincel para regiões livres, conta-gotas para preencher superfícies inteiras com um clique e borracha para corrigir sem recomeçar.', en: 'Three selection modes work together: brush for free regions, eyedropper to fill whole surfaces with one click, and eraser to fix without starting over.' },
  ld_in1_b1:         { pt: 'Pincel com clique-e-arrasta para o controle fino', en: 'Click-and-drag brush for fine control' },
  ld_in1_b2:         { pt: 'Conta-gotas: um clique preenche a região conectada', en: 'Eyedropper: one click fills the connected region' },
  ld_in1_b3:         { pt: 'Borracha apaga só o que você quiser refazer', en: 'Eraser removes only what you want to redo' },
  ld_in2_t:          { pt: 'Sensibilidade e alcance sob o seu controle', en: 'Sensitivity and reach under your control' },
  ld_in2_d:          { pt: 'Ajuste o ângulo de parada para respeitar dobras suaves e limite o raio de expansão para isolar dedos, encaixes e peças pequenas com precisão.', en: 'Tune the stop angle to respect gentle folds and cap the expansion radius to isolate fingers, joints and small parts with precision.' },
  ld_in2_b1:         { pt: 'Ângulo de parada de 1° a 45° — de superfícies planas a arestas', en: 'Stop angle from 1° to 45° — from flat surfaces to hard edges' },
  ld_in2_b2:         { pt: 'Raio máximo de expansão de até 300 mm', en: 'Maximum expansion radius up to 300 mm' },
  ld_in2_b3:         { pt: 'Preencher falhas automático e Ctrl+Z para desfazer', en: 'Automatic gap filling and Ctrl+Z to undo' },
  ld_how_title:      { pt: 'Como funciona', en: 'How it works' },
  ld_how1_t:         { pt: 'Importe o modelo', en: 'Import the model' },
  ld_how1_d:         { pt: 'Arraste seu STL — vértices, faces, dimensões, volume e status watertight aparecem na hora.', en: 'Drag your STL in — vertices, faces, dimensions, volume and watertight status show up instantly.' },
  ld_how2_t:         { pt: 'Pinte a divisão', en: 'Paint the split' },
  ld_how2_d:         { pt: 'A área pintada vira a Parte B (cavidades); o resto vira a Parte A (pinos). Visualize antes de cortar.', en: 'The painted area becomes Part B (cavities); the rest becomes Part A (pins). Preview before cutting.' },
  ld_how3_t:         { pt: 'Exporte e imprima', en: 'Export and print' },
  ld_how3_d:         { pt: 'Peças separadas com encaixes e folga calibrada para FDM, prontas para o fatiador da sua impressora.', en: 'Separate parts with joints and FDM-calibrated clearance, ready for your printer’s slicer.' },

  // ── Compra de acesso ──────────────────────────────────────────────────────
  buy_title:         { pt: 'Comprar acesso', en: 'Buy access' },
  buy_subtitle:      { pt: 'Escolha o plano, preencha seus dados e receba login e senha por e-mail. Sem criação manual de conta.', en: 'Pick a plan, fill in your details and receive login and password by e-mail. No manual sign-up.' },
  buy_back:          { pt: '← Voltar', en: '← Back' },
  buy_your_data:     { pt: 'Seus dados', en: 'Your details' },
  buy_nome:          { pt: 'Nome completo', en: 'Full name' },
  buy_telefone:      { pt: 'Telefone (WhatsApp)', en: 'Phone (WhatsApp)' },
  buy_confirm:       { pt: 'Confirmar compra', en: 'Confirm purchase' },
  buy_processing:    { pt: 'Processando…', en: 'Processing…' },
  buy_selected:      { pt: 'Plano selecionado', en: 'Selected plan' },
  buy_success_title: { pt: 'Compra confirmada! 🎉', en: 'Purchase confirmed! 🎉' },
  buy_success_msg:   { pt: 'Sua conta foi criada automaticamente. Você receberá o login, a senha e o código de acesso por e-mail em instantes.', en: 'Your account was created automatically. You will receive login, password and access code by e-mail shortly.' },
  buy_renewed_msg:   { pt: 'Acesso renovado! Use suas credenciais atuais para entrar.', en: 'Access renewed! Use your current credentials to sign in.' },
  buy_go_login:      { pt: 'Ir para o login', en: 'Go to sign in' },
  buy_err_telefone:  { pt: 'Digite um telefone válido.', en: 'Enter a valid phone number.' },
  buy_err_generic:   { pt: 'Não foi possível concluir a compra. Tente novamente.', en: 'Could not complete the purchase. Try again.' },

  // ── Painel administrativo ─────────────────────────────────────────────────
  adm_title:         { pt: 'Painel administrativo', en: 'Admin panel' },
  adm_login_btn:     { pt: 'Entrar no painel', en: 'Enter panel' },
  adm_search:        { pt: 'Buscar cliente…', en: 'Search client…' },
  adm_all_fields:    { pt: 'Todos os campos', en: 'All fields' },
  adm_f_nome:        { pt: 'Nome', en: 'Name' },
  adm_f_email:       { pt: 'E-mail', en: 'E-mail' },
  adm_f_telefone:    { pt: 'Telefone', en: 'Phone' },
  adm_col_plano:     { pt: 'Plano', en: 'Plan' },
  adm_col_compra:    { pt: 'Compra', en: 'Purchase' },
  adm_col_status:    { pt: 'Status', en: 'Status' },
  adm_col_codigo:    { pt: 'Código', en: 'Code' },
  adm_col_senha:     { pt: 'Senha temp.', en: 'Temp pass.' },
  adm_col_acoes:     { pt: 'Ações', en: 'Actions' },
  adm_reset:         { pt: 'Resetar senha', en: 'Reset password' },
  adm_send:          { pt: 'Enviar acesso', en: 'Send access' },
  adm_block:         { pt: 'Bloquear', en: 'Block' },
  adm_unblock:       { pt: 'Desbloquear', en: 'Unblock' },
  adm_history:       { pt: 'Histórico', en: 'History' },
  adm_sent_ok:       { pt: 'Acesso enviado', en: 'Access sent' },
  adm_reset_ok:      { pt: 'Nova senha gerada', en: 'New password generated' },
  adm_empty:         { pt: 'Nenhum cliente encontrado.', en: 'No clients found.' },
  adm_logout:        { pt: 'Sair do painel', en: 'Leave panel' },
  adm_hist_compras:  { pt: 'Compras', en: 'Purchases' },
  adm_hist_emails:   { pt: 'E-mails enviados', en: 'E-mails sent' },
  adm_hist_login:    { pt: 'Último login', en: 'Last login' },
  adm_hist_none:     { pt: 'nenhum', en: 'none' },
  adm_create:        { pt: 'Criar usuário', en: 'Create user' },
  adm_create_btn:    { pt: 'Criar e gerar acesso', en: 'Create & generate access' },
  adm_created_ok:    { pt: 'Usuário criado', en: 'User created' },
  adm_err_email_exists: { pt: 'E-mail já cadastrado.', en: 'E-mail already registered.' },
  adm_plan_none:     { pt: 'Sem plano (só login)', en: 'No plan (login only)' },
  adm_periodo:       { pt: 'Período', en: 'Period' },
  adm_mensal:        { pt: 'Mensal', en: 'Monthly' },
  adm_anual:         { pt: 'Anual', en: 'Yearly' },
  adm_setpw:         { pt: 'Definir senha', en: 'Set password' },
  adm_setpw_prompt:  { pt: 'Nova senha (mín. 6 caracteres) para', en: 'New password (min. 6 chars) for' },
  adm_setpw_short:   { pt: 'A senha precisa de pelo menos 6 caracteres.', en: 'Password needs at least 6 characters.' },
  adm_setpw_ok:      { pt: 'Senha definida', en: 'Password set' },
